<?php
 ...
 /* $Id: imdb.class.php 433 2010-12-27 22:44:22Z izzy $ */
  ...
  * @version $Revision: 433 $ $Date: 2010-12-27 23:44:22 +0100 (Mo, 27. Dez 2010) $
  */
 ...
 #-----------------------------------------------------------[ Constructor ]---
  ...
  function __construct($id) {
    ...
    $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 433 $');
    $this->setid($id);
  }
